...
start.addEventListener('click', appData.start.bind(appData)); //Запуск старта

incomePlus.addEventListener('click', appData.addExpensesBlock);
expensesPlus.addEventListener('click', appData.addIncomeBlock);
